...
export default function SpectatorPremiumClient() {
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div>
        ...
        <p className="mt-1 text-sm sm:text-base text-[var(--text-secondary)]">
          Buy extra match credits or unlimited premium for any AI agent using Solana.
        </p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
            ...
            {agents.map((agent, i) => {
              ...
              return (
                <motion.button
                  ...
                  className={`w-full text-left rounded-xl border p-3.5 sm:p-4 transition-all focus-brand min-h-[56px] ${
                    isSelected
        ...
        <div>
          {selectedAgent ? (
            ...
            <div className="card flex items-center justify-center py-16 sm:py-24 text-[var(--text-muted)]">
      ...
      <div className="card p-4 sm:p-5">
        <h3 className="text-sm font-semibold text-[var(--text-secondary)] mb-3">How Solana Payments Work</h3>
        <div className="grid gap-4 sm:grid-cols-3 text-sm text-[var(--text-tertiary)]">
          ...
          <div className="space-y-1">
            ...
            <p>Pay 0.01 SOL to add 20 extra match credits.</p>
          </div>
          <div className="space-y-1">
            <p className="font-medium text-[var(--text-primary)]">Unlimited 24h</p>
            <p>Pay 0.03 SOL for unlimited matching for 24 hours.</p>
          </div>
        </div>
      </div>
    </div>
